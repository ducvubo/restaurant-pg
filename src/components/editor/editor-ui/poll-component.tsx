...
import type { Option, Options, PollNode } from '@/registry/new-york/editor/nodes/poll-node'
import { $isPollNode, createPollOption } from '@/registry/new-york/editor/nodes/poll-node'
