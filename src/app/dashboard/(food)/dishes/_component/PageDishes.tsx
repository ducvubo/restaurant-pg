  ...
  return (
    <div className='flex flex-col h-[570px]'>
       <div className='flex justify-end gap-2 items-center py-4'>
        <Button variant={'outline'}><Link href={'/dashboard/dishes/add'}>Thêm</Link></Button>
        <Button variant={'outline'}><Link href={'/dashboard/dishes/recycle'}  >Danh sách đã xóa</Link></Button>
