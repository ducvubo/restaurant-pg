...
// import { db, collection, onSnapshot, query, orderBy, doc, getDoc, setDoc, addDoc, writeBatch } from "@/app/configs/firebase";
// import { Input } from "@/components/ui/input";
// import { Button } from "@/components/ui/button";
// import { ScrollArea } from "@/components/ui/scroll-area";
// import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";

// const Chat = ({ restaurantId, customerId, userType }: any) => {
//   const [messages, setMessages] = useState([]);
//   const [newMessage, setNewMessage] = useState("");
//   const [username, setUsername] = useState(customerId);
...
//         </Avatar>
//         <h2 className="text-lg font-bold dark:text-white text-block">{username}</h2>
//       </div>
...
//           >
//             {/* <div
//               className={`max-w-xs p-3 rounded-lg ${msg.userType === userType ? "bg-blue-600 text-white" : "bg-gray-700 text-white"
//                 }`}
//             >
//               <p>{msg.text}</p>
