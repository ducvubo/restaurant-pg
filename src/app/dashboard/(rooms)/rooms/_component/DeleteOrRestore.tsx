...
export default function DeleteOrRestore({ inforRoom, path }: Props) {
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>{path === 'delete' ? 'Xóa phòng/sảnh' : 'Khôi phục phòng/sảnh'} </AlertDialogTitle>
          <AlertDialogDescription>
            {path === 'delete'
              ? `Bạn có chắc muốn chuyển phòng/sảnh này vào thùng rác không?`
              : `Bạn có chắc muốn khôi phục phòng/sảnh này không?`}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel>Không</AlertDialogCancel>
          <AlertDialogAction onClick={() => handleDeletedRoom(inforRoom.room_id ? inforRoom.room_id : '')}>
            Có
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
