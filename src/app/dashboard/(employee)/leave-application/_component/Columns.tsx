...
import { Ban, Check, Edit, Eye, Send, X } from 'lucide-react'
          ...
          <div className="flex gap-2">
            {inforEmployee._id && (
              <>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" onClick={() => router.push(`/dashboard/leave-application/view?id=${leaveApplication.leaveAppId}`)}>
            ...
            {inforRestaurant._id && (
              <>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" onClick={() => router.push(`/dashboard/leave-application/view-restaurant?id=${leaveApplication.leaveAppId}`)}>
                      <Eye className="h-4 w-4" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
