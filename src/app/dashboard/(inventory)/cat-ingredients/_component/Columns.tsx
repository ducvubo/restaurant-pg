...
export const columns: ColumnDef<ICatIngredient>[] = [
  ...
  {
    accessorKey: 'cat_igd_description',
    id: 'Mô tả',
    header: () => <div className='font-semibold'>Mô tả</div>,
    enableHiding: true
  },
  {
    accessorKey: 'cat_igd_status',
    id: 'Trạng thái',
    ...
    cell: ({ row }) => {
      ...
      const handleUpdateStatus = async () => {
        const res = await updateStatus({
          cat_igd_id: catIngredient.cat_igd_id ? catIngredient.cat_igd_id : '',
          cat_igd_status: catIngredient.cat_igd_status === 'enable' ? 'disable' : 'enable'
        })
...

  {
    ...
    cell: ({ row }) => {
      ...
      if (pathname === 'recycle') {
        return <DeleteOrRestore inforCatIngredient={catIngredient} path={pathname} />
      }
      return (
        <DropdownMenu>
