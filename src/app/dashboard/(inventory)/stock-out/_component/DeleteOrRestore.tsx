    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {path === 'delete'
              ? `Bạn có chắc muốn chuyển phiếu nhập '${inforStockOut.stko_code}' vào thùng rác không?`
              : `Bạn có chắc muốn khôi phục phiếu nhập '${inforStockOut.stko_code}' không?`}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel>Không</AlertDialogCancel>
          <AlertDialogAction onClick={() => handleDelete(inforStockOut.stko_id ? inforStockOut.stko_id : '')}>
            Có
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
